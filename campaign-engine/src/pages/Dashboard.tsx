  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          to="/campaigns/create"
          className="inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-primary-foreground transition-all duration-150 hover:opacity-90"
          ...
          {recentCampaigns.length === 0 ? (
            ...
            recentCampaigns.map((campaign) => {
              ...
              return (
                <div
                  key={campaign.id}
                  className="px-6 py-4 flex items-center justify-between hover:bg-black/[0.04] transition-colors"
                >
